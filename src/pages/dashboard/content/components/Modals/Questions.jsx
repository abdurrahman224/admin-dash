...
const Questions = ({activeTab,handleCreateTheme}) => {
    return (
       <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">


      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl sm:max-w-md md:max-w-3xl max-h-[90vh] overflow-y-auto pb-4">
        ...
        <div className="p-6 border-b border-gray-200 relative">
          ...
          <button onClick={handleCreateTheme} className="absolute top-6 right-6 text-gray-400 hover:text-gray-700 text-2xl leading-none transition duration-150">
            &times;
          </button>
        </div>
        ...
        <div className="p-6 space-y-5 bg-[#FFFFFF]">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 border border-[#F18A91] rounded-lg text-sm text-[#F18A91] resize-none focus:outline-none focus:ring-2 focus:ring-[#F18A91] focus:border-[#F18A91] transition duration-150"
            ></textarea>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  id="difficulty"
                  // Updated border color, padding, and focus ring
                  className="appearance-none w-full px-4 py-3 border border-[#F18A91] rounded-lg text-sm text-[#F18A91] bg-white pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150"
                >
          ...
          <div className="space-y-4">
            ...
            {['Answer Option 1', 'Answer Option 2', 'Answer Option 3', 'Answer Option 4'].map((placeholder, index) => (
              <input
                key={index}
                type="text"
          ...
          <div>
            ...
            <div className="flex flex-col items-center justify-center h-32 border-2 border-[#F18A91] rounded-lg   text-[#5F0006]cursor-pointer hover:border-[#F18A91] hover:bg-indigo-50 transition duration-150 p-4">
              ...
              <svg className="mx-auto h-8 w-8 text-[#F18A91]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="mt-2 text-xs text-[#5F0006]">Drag and drop or click to upload</p>
            </div>
          </div>

        </div>

        {/* 5. Footer/Action Buttons Section */}
        <div className="flex items-center justify-end gap-3 px-6  py-4">
          <button onClick={handleCreateTheme} className="w-[102px] h-[35px] px-3 py-2 gap-1 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50 transition-colors">
            Cancel
          </button>
          {/* Primary button using Indigo for emphasis */}
          <button  className="w-[102px] h-[35px]  gap-1 text-sm font-medium text-white bg-gradient-to-r from-[#E1000F] to-[#3333A7] rounded transition-colors hover:from-[#7C0008] hover:to-blue-700 shadow-sm">
            Save Question
          </button>
        </div>
